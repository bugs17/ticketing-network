...
export default function LandingPage() {
  ...
  return (
    ...
    <div className="min-h-screen md:h-screen w-screen bg-white text-zinc-900 flex flex-col overflow-y-auto md:overflow-hidden selection:bg-emerald-100 relative bg-[radial-gradient(#e4e4e7_1px,transparent_1px)] [background-size:16px_16px]">
      ...
      <header className="border-b border-zinc-100 bg-white/95 backdrop-blur-sm z-50 shrink-0 sticky top-0 md:relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-zinc-950 flex items-center justify-center shadow-md shadow-zinc-200 shrink-0">
              <TicketCheck className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
            </div>
            <div>
              <span className="font-bold tracking-tight block text-sm sm:text-base text-zinc-950">
                NetTick <span className="font-medium text-zinc-400">Mimika</span>
              </span>
              <span className="text-[9px] sm:text-[10px] text-emerald-600 block -mt-0.5 font-bold tracking-wider uppercase">
                DISKOMINFO KAB. MIMIKA
              </span>
            </div>
          </div>

          <nav className="flex items-center gap-2 sm:gap-3">
            <Badge variant="secondary" className="bg-emerald-50 text-emerald-700 border border-emerald-200 font-medium text-[10px] sm:text-xs px-2.5 sm:px-3 py-1 flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-emerald-500 animate-pulse"></span>
              <span className="hidden sm:inline">Layanan Aktif</span>
            ...
            <LoginDialog>
              <span className="cursor-pointer bg-zinc-950 hover:bg-zinc-800 text-white text-xs font-semibold px-3 sm:px-4 py-2 rounded-xl transition-all flex items-center gap-1.5 sm:gap-2">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full">
          ...
          <section className="lg:col-span-7 space-y-4 sm:space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.15] text-zinc-950">
              Pengaduan Jaringan OPD <span className="text-emerald-600 block sm:inline">Tercatat & Terukur.</span>
            </h1>
            ...
            {/* Rekapitulasi Operasional Bar (Real Data Database) */}
            <div className="py-3 sm:py-4 border-y border-zinc-100 flex flex-row items-center justify-center lg:justify-start gap-4 sm:gap-8 my-2">
              <div className="flex items-center gap-2.5 sm:gap-3 text-left">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600 border border-emerald-100 shrink-0">
              ...
              <div className="flex items-center gap-2.5 sm:gap-3 text-left">
                ...
                <div>
                  ...
                  <span className="block text-sm sm:text-base font-bold text-zinc-950">
                    {loading ? "..." : `${stats.avgMinutes} Mnt`} <span className="text-[10px] sm:text-xs font-semibold text-emerald-600">&lt; SLA</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-1 sm:pt-2 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4">
              <LoginDialog>
                <span className="w-full sm:w-auto bg-zinc-950 cursor-pointer hover:bg-zinc-900 text-white px-6 sm:px-7 py-3 sm:py-3.5 rounded-xl sm:rounded-2xl font-semibold text-xs sm:text-sm shadow-md shadow-zinc-200 flex items-center justify-center gap-2.5 transition-all active:scale-[0.98]">
                  Masuk Portal Petugas <LogIn className="w-4 h-4 text-zinc-400" />
                </span>
              </LoginDialog>
              ...
              <div className="text-center sm:text-left">
                <span className="block text-[11px] sm:text-xs font-semibold text-zinc-800 flex items-center justify-center sm:justify-start gap-1">
                  <ShieldCheck className="w-3.5 h-3.5 text-emerald-600 shrink-0" /> Khusus Internal Diskominfo & Admin OPD
                </span>
          ...
          <aside className="lg:col-span-5 w-full">
            ...
            <div className="relative p-[1.5px] rounded-2xl sm:rounded-3xl overflow-hidden group shadow-xl sm:shadow-2xl shadow-zinc-200/80">
              ...
              <div className="absolute inset-0 bg-[conic-gradient(from_0deg,transparent_40%,#10b981_70%,transparent_100%)] animate-[spin_5s_linear_infinite] opacity-80 group-hover:opacity-100 transition-opacity" />
              
              <div className="absolute -top-10 -right-10 w-32 h-32 sm:w-40 sm:h-40 bg-emerald-500/20 rounded-full blur-2xl pointer-events-none animate-pulse"></div>
                      ...
                      stats.recentTickets.map((ticket) => (
                        <div key={ticket.id} className="bg-zinc-900/50 border border-zinc-800/50 p-2.5 rounded-xl flex items-start justify-between gap-2.5">
                          ...
                          <span className={`text-[9px] font-mono shrink-0 bg-zinc-900 px-1.5 py-0.5 rounded capitalize ${
                            ticket.status === 'selesai' ? 'text-emerald-400' :
