  ...
  const handleImageUpload = (e, type) => {
    ...
    reader.onload = (event) => {
      ...
      img.onload = () => {
        ...
        const MAX_WIDTH = 800; // Batasi lebar maksimal 800px (cukup tajam untuk dokumentasi)
        ...
        // Kompres ke format JPEG dengan kualitas 0.7 (70%) agar ukuran file kecil (~100-300 KB)
        const compressedDataUrl = canvas.toDataURL("image/jpeg", 0.7);

        if (type === "before") setBeforeImage(compressedDataUrl);
        if (type === "after") setAfterImage(compressedDataUrl);
      };
    };
